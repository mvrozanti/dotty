...
* Usage
  #+BEGIN_SRC sh
    ...
    optional arguments:
      ...
      -c, --clear    remove files listed in the copy section of config file from config directory
      -e, --eject    run --clear and move config folder to another location (thank hoberto)
  #+END_SRC 
